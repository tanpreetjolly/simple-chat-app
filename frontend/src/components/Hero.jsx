    ...
    <section className="">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          {!isAuthenticated && <Link
            to={"/register"}
            className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border rounded-lg dark:text-white border-gray-700 hover:bg-gray-700 focus:ring-gray-800"
          >
            Register
          </Link>}
        </div>
